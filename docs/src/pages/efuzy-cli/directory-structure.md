...
desc: The structure of a Efuzy app with explanations for each folder and file.
---
This is the structure of a project with all modes installed. There's no reason to be intimidated though!

::: tip
If you are a beginner, all you'll need to care about is `/efuzy.conf.js` (Efuzy App Config file), `/src/router`, `/src/layouts`, `/src/pages` and optionally `/src/assets`.
:::
...
|   |   ├── app.styl
|   │   └── efuzy.variables.styl # Efuzy Stylus variables for you to tweak
...
│   └── ....
├── efuzy.conf.js           # Efuzy App Config file
