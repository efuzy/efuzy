---
title: App Linter
desc: How to configure a code linter in a Efuzy app.
---
...
When you create a Efuzy project folder with Efuzy CLI it will ask you if you want a linter and which setup you want for ESLint:
...
If you chose ESLint when creating your project folder, you'll also notice that `/efuzy.conf.js` adds the eslint-loader to Webpack configuration for you:
...
## Disabling Linter
In order for you to disable ESLint later, all you need to do is comment out (or remove) the following code from `/efuzy.conf.js`:
