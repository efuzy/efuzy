...
For larger edits change the Efuzy source files (located [here](https://github.com/efuzy/efuzy/tree/dev/docs/src/pages) on GitHub).
...
## Contributing to the Efuzy UI Source Code
