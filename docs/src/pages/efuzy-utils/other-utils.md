---
title: Other Utils
desc: A set of miscellaneous Efuzy methods for debouncing or throttling functions, deep copying objects, cross-platform URL opening or handling DOM events.
---
...
Starting with Efuzy v1.11+, if running on iOS and [cordova-plugin-safariviewcontroller](https://github.com/EddyVerbruggen/cordova-plugin-safariviewcontroller) is installed, then openURL will first try to hook into it.
...
``` js
import { frameDebounce } from 'efuzy'
