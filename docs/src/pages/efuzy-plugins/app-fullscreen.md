...
desc: A Efuzy plugin to toggle the fullscreen state of your app through the Web Fullscreen API.
---
There are times when you want your website or App to run in fullscreen.
Efuzy makes it easy by wrapping the [Web Fullscreen API](https://developer.mozilla.org/en-US/docs/Web/API/Fullscreen_API).
