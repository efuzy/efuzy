    ...
    <div class="q-layout-padding q-mx-auto" style="max-width: 500px">
      ...
      <q-list bordered padding class="q-my-md" :dark="dark" :separator="separator">
        ...
        <q-item clickable v-ripple>
          <q-item-section avatar>
            <q-icon color="primary" name="img:https://cdn.efuzy.dev/logo/svg/efuzy-logo.svg" />
          </q-item-section>
          <q-item-section>List item</q-item-section>
        </q-item>
      ...
      <q-list bordered padding class="q-my-md" :dark="dark">
        ...
        <q-item>
          <q-item-section top thumbnail class="q-ml-none">
            <img class="rounded-borders" src="https://cdn.efuzy.dev/img/mountains.jpg">
          </q-item-section>
    ...
    <div class="q-layout-padding" style="max-width: 700px">
      ...
      <q-list class="shadow-1 q-pa-none">
        ...
        <q-item>
          ...
          <q-item-section top>
            <q-item-label lines="1">
              <span class="text-weight-medium">[efuzy/efuzy-cli]</span>
              <span class="text-grey-8"> - GitHub repository</span>
            </q-item-label>
            <q-item-label caption lines="1">
