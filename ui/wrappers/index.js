...
//  parameters and return value when using Efuzy with TypeScript
// We need these in `ui` folder to make `efuzy/wrapper` import work,
//  but they are useful only for Efuzy CLI projects
// They are typed via module augmentation by `@efuzy/app`
