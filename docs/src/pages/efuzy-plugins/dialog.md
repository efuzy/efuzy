---
title: Dialog Plugin
desc: A Efuzy plugin that provides an easy way to display a prompt, choice, confirmation or alert in the form of a dialog.
related:
  - /vue-components/dialog
  - /efuzy-plugins/bottom-sheet
---

Efuzy Dialogs are a great way to offer the user the ability to choose a specific action or list of actions. They also can provide the user with important information, or require them to make a decision (or multiple decisions).
...
The advantage of using Dialogs as Efuzy Plugins as opposed to QDialog component is that the plugin can also be called from outside of Vue space and doesn't require you to manage their templates. But as a result, their customization cannot be compared to their component counterpart.
...
::: warning
This is not an exhaustive list of what you can do with Dialogs as Efuzy Plugins. For further exploration check out the API section.
:::
