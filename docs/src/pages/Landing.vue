...
.landing.text-white
      ...
      .relative-position.text-center
        ...
        .q-pt-md.q-pl-sm
          .landing__hero-row.landing__hero-btns.q-gutter-sm.row.items-center.justify-center
            ...
            q-btn(color="white" text-color="primary" no-caps to="/introduction-to-efuzy" label="Why Efuzy?")
  ...
  section.padding.bg-white.text-grey-10.text-center
    .landing__features.row.items-start.q-col-gutter-xl
      ...
      .col-12.text-center
        p One source code for all platforms simultaneously through Efuzy CLI with all the latest and greatest best practices out of the box. Focus only on your app's features and forget about the boilerplate around it.
      .col-12.q-gutter-md
        q-btn(color="red", no-caps, no-wrap, :icon-right="mdiLaunch", label="User Interface Components", to="/vue-components")
        q-btn(color="primary", no-caps, no-wrap, :icon-right="mdiLaunch", label="SPA (Single Page App)", to="/efuzy-cli/developing-spa/introduction")
        q-btn(color="teal", no-caps, no-wrap, :icon-right="mdiLaunch", label="PWA (Progressive Web App)", to="/efuzy-cli/developing-pwa/introduction")
        q-btn(color="pink", no-caps, no-wrap, :icon-right="mdiLaunch", label="BEX (Browser Extension)", to="/efuzy-cli/developing-browser-extensions/introduction")
        q-btn(color="accent", no-caps, no-wrap, :icon-right="mdiLaunch", label="SSR (Server-side Rendered App)", to="/efuzy-cli/developing-ssr/introduction")
        q-btn(color="orange", no-caps, no-wrap, :icon-right="mdiLaunch", label="Hybrid Mobile App", to="/efuzy-cli/developing-mobile-apps")
        q-btn(color="indigo", no-caps, no-wrap, :icon-right="mdiLaunch", label="Multi-platform Desktop App", to="/efuzy-cli/developing-electron-apps/introduction")
    ...
    .landing__features.row.justify-between.items-start.q-col-gutter-xl
      ...
      .col-xs-12.col-sm-5
        .landing__feature-item
          ...
          h6 Efuzy's goal
          p What we want to achieve with Efuzy is to raise the bar for web development as a whole. Make it go forward, evolve. Change minds. Point out when there’s a better alternative to current establishment. You deserve a stellar development experience.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(:name="fabGoogle")
          h6 Material Design 2.0
          p Efuzy is focused on following the Material 2.0 Guidelines and to stay up-to-date to them.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="group_add")
          h6 Big community
          p We have grown into a big community. You can get help or advise others through Efuzy's Discord chat server or the Efuzy Forum. You're not alone.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="flash_on")
          h6 Top Class, Fast Web Components
          p There's a component for almost every web development need out there. Each of these components are carefully crafted to offer the best possible experience to your users. Efuzy is designed with performance and responsiveness in mind – so the overhead of using Efuzy is barely noticeable. This is an area we take special pride in.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="settings_applications")
          h6 Best practices integrated by default
          p Efuzy developers are encouraged to follow web development best practices, and Efuzy comes with many embedded features to that regard out of the box. HTML/CSS/JS minification, cache busting, tree shaking, source-mapping, code-splitting and lazy loading, ES6 transpiling, linting code, accessibility features. Efuzy takes care of all these and more - no configuration needed.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="format_align_right")
          h6 Full RTL support
          p RTL (right to left) support for both Efuzy components and developer's own code. Developer-written website/app CSS code gets automatically converted to RTL, if an RTL language pack is used.
      ...
      .col-xs-12.col-sm-5
        .landing__feature-item
          ...
          p There's more than 40 Efuzy language packs available. If your desired language pack is missing it takes just 5 minutes to add it.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="collections_bookmark")
          h6 Great documentation
          p It's worth mentioning the significant amount of time that is spent on writing great, bloat-free, focused, complete documentation pages so you as a developer can quickly pick up Efuzy.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="security")
          h6 We care deeply about Security
          p We are always paranoid about the security of Efuzy and the security of apps built with Efuzy. We are on a constant lookout to inform you about any security threats that you might need to know about. We have Security guidelines and we are even offering our security expertise through the Efuzy Audit program.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="exit_to_app")
          h6 Progressively migrate your existing project
          p Efuzy offers a UMD (Unified Module Definition) version, which you add as a CSS and a JS HTML tags into an existing project and you're ready to use it. No build step is required.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="star")
          h6 Unparalleled developer experience through Efuzy CLI
          p Efuzy CLI takes care of all the quirks involved in developing an SPA, PWA, SSR, Mobile and Electron App.

      .col-xs-12.col-sm-5
        .landing__feature-item
          q-icon(name="important_devices")
          h6 Focus on your App
          p Your full focus is on your App's content rather than all other boilerplating stuff around it (build system, layout, and much more). You'll be spending time only on what matters, which is your product. Efuzy greatly increases your productivity.
...
import IntroductionVideo from 'components/page-parts/introduction-to-efuzy/IntroductionVideo'
