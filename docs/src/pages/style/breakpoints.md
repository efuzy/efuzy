---
title: Breakpoints
desc: Efuzy's list of CSS breakpoints.
related:
  - /style/spacing
---

Efuzy uses the following CSS breakpoints:
...
Starting with **Efuzy v1.5.3+**, [if enabled (only)](/options/screen-plugin#How-to-enable-body-classes), you can also style your content based on a particular set of CSS classes applied to document.body: `screen--xs`, `screen--sm`, ..., `screen--xl`.
