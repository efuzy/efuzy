  ...
  <div>
    <div class="q-layout-padding">
      ...
      <div class="column q-gutter-md" style="font-size: 2rem; margin-top: 20px;">
        ...
        <q-rating size="3rem" color="red" v-model="ratingModel" :max="6" icon="img:https://cdn.efuzy.dev/logo/svg/efuzy-logo.svg" />
      ...
      <div class="column q-gutter-md" style="font-size: 2rem; margin-top: 20px;">
        ...
        <q-rating size="3rem" color="red" v-model="halfModel" :max="6" icon="img:https://cdn.efuzy.dev/logo/svg/efuzy-logo.svg" icon-half="star_half" />
