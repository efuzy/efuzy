  ...
  <div class="view-parallax">
    ...
    <q-parallax>
      <template v-slot:media>
        <img src="https://cdn.efuzy.dev/img/parallax2.jpg">
      </template>
    ...
    <q-parallax class="q-mt-xl">
      ...
      <template v-slot:content="scope">
        ...
        >
          <img src="https://cdn.efuzy.dev/img/efuzy-logo.png" style="width: 150px; height: 150px">
    ...
    <q-toggle v-model="imgSrc" true-value="https://cdn.efuzy.dev/img/parallax1.jpg" false-value="https://cdn.efuzy.dev/img/mountains.jpg" label="Toggle Image" />
    ...
    <q-parallax src="https://cdn.efuzy.dev/img/parallax2.jpg">
      <h1 class="text-white">
        Bridge
      </h1>
    </q-parallax>
    ...
    <q-parallax src="https://cdn.efuzy.dev/img/parallax1.jpg">
      <h1 class="text-white">
        Title
      </h1>
    </q-parallax>
    ...
    <q-parallax src="https://cdn.efuzy.dev/img/mountains.jpg" :height="200">
      <h1 class="text-white">
        Mountains
      </h1>
    </q-parallax>
...
export default {
  data () {
    return {
      imgSrc: 'https://cdn.efuzy.dev/img/parallax1.jpg',
