---
title: App Routing
desc: How to use the Vue Router in a Efuzy app.
---

You'll notice that your Efuzy project contains a `/src/router` folder. This holds the routing configuration of your website/app:
