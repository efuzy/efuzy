    ...
    <q-list bordered separator>
      ...
      <q-slide-item @left="onLeft" @right="onRight">
        ...
        <q-item>
          <q-item-section avatar>
            <q-avatar>
              <img src="https://cdn.efuzy.dev/img/avatar2.jpg" draggable="false">
            </q-avatar>
          </q-item-section>
      ...
      <q-slide-item @left="onLeft" @right="onRight">
        ...
        <q-item>
          <q-item-section avatar>
            <q-avatar>
              <img src="https://cdn.efuzy.dev/img/avatar3.jpg" draggable="false">
            </q-avatar>
          </q-item-section>
      ...
      <q-slide-item @left="onLeft" @right="onRight">
        <q-item>
          <q-item-section avatar>
            <q-avatar>
              <img src="https://cdn.efuzy.dev/img/avatar5.jpg" draggable="false">
            </q-avatar>
          </q-item-section>
