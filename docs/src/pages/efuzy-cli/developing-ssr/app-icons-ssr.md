...
desc: How to manage the app icons for a Efuzy server-side rendered app.
---
...
And the corresponding HTML code to go into `/src/index.template.html` file (notice not all files need to be manually referenced as Efuzy CLI automatically injects the other ones):
