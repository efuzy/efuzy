...
desc: A set of Efuzy methods for formatting values. Capitalizing, padding, normalizing and more. 
---

### Helping Tree-Shake
You will notice all examples import `format` Object from Efuzy. However, if you need only one formatter method from it, then you can use ES6 destructuring to help Tree Shaking embed only that method and not all of `format`.
