...
desc: How to manage the app icons for a Efuzy Browser Extension (BEX).
---

This build target includes the icons required for browser extensions. You need all of them - and if you discover one that is new or missing, please [open an issue](https://github.com/efuzy/efuzy/issues).
