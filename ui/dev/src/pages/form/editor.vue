...
export default {
  data () {
    return {
      ...
      model: 'Editor in <a href="http://efuzy.dev">Efuzy</a></div><div>Second line',
      modelScroll: 'Editor in <a href="http://efuzy.dev">Efuzy</a></div><div style="height: 500px; background: yellow">Spacer 1</div><div style="height: 500px; background: yellow">Spacer 2</div><div>Second line'
    }
  },
  watch: {
    btnType (val) {
