---
title: Ajax Requests
desc: Using Axios for fetching data in a Efuzy app.
---

> Efuzy recommends Axios during project initialization: `Use Axios for Ajax calls? (Y/n)`
...
::: tip
Be sure to check out [Prefetch Feature](/efuzy-cli/prefetch-feature) if you are using Efuzy CLI.
:::
