...
Hi! I’m really excited that you are interested in contributing to Efuzy. Before submitting your contribution though, please make sure to take a moment and read through the following guidelines.
...
- The issue list of this repo is **exclusively** for bug reports and feature requests. Non-conforming issues will be closed immediately.
  ...
  - For more complicated questions, you can use [the official forum](https://forum.efuzy.dev/). Make sure to provide enough information when asking your questions - this makes it easier for others to help you!
...
- **`src`**: contains the source code, obviously. The codebase is written in ES2015.
  ...
  - **`components`**: JS and Stylus files (one for each theme) for Efuzy Vue components
  ...
  - **`index.js`**: starting point for Efuzy
...
Efuzy Framework is an MIT-licensed open source project. Its ongoing development is made possible thanks to the support by these awesome [backers](../backers.md).
